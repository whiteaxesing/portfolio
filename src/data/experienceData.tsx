...
export const experiences: Experience[] = [
  {
    ...
    responsibilities: [
      'Developed new enterprise systems and maintained existing ones using Java Spring Boot, PrimeFaces, and Oracle SQL',
      'Migrated entire databases from legacy data sources to Oracle SQL using Python migration scripts',
      'Created and optimized stored procedures and functions, significantly reducing query execution times and resource consumption',
      'Reviewed code changes from other developers, ensuring quality and best practices',
      'Assisted teammates with architecture planning and deployment strategies for production changes',
      'Generated dynamic business reports using JasperReports',
    ],
    achievements: [
      'Successfully migrated complete database systems from legacy data sources to Oracle SQL through automated Python scripting',
      'Reduced query execution times and resource usage through stored procedure optimization',
      'Acted as technical reference for architecture planning and peer code reviews',
      'Delivered new systems and features for critical national infrastructure at ICE',
    ],
    technologies: [
      'Java',
      'Spring Boot',
